...
import { getTransferredFileEntries } from './helpers/filesystem';
import {
...
export class NgxDropzoneDirective implements OnDestroy, AfterContentInit {
  ...
  ngAfterContentInit(): void {
    ...
    // TODO : Uncomment to listen for change event on the file input
